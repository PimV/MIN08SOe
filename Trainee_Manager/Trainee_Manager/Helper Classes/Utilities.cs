...
namespace Trainee_Manager.Helper_Classes
{
    public static class Utilities
    {
        ...
        (System.Reflection.Assembly.GetExecutingAssembly().Location, true);
        }

        public static void UnprotectConnectionString()
        {
            ToggleConnectionStringProtection
        (System.Reflection.Assembly.GetExecutingAssembly().Location, false);
        }
